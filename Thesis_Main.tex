...
\afterpreface                      
  \include{chapters_after_preface/1_introduction}
    ...
    \include{chapters_after_preface/Background}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

    \include{chapters_after_preface/Methodology}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

    \include{chapters_after_preface/Implementation}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
    

    \include{chapters_after_preface/Experiments}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

    \include{chapters_after_preface/Conclusion}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
