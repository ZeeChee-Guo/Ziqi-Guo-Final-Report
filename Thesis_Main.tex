...
\usepackage{amsfonts}       
\usepackage{xcolor}  % Extended fonts for mathematics
\numberwithin{equation}{section}                 % Numbers equations based on their section

\newcommand{\fei}[1]{{\noindent \color{red}{Comment(Fei): #1}}}
\newcommand{\red}[1]{\textcolor{red}{#1}}


\definecolor{darkgold}{RGB}{255,128,0}
\newcommand{\reply}[2]{%
\noindent\textcolor{darkgold}{\textbf{Response:} #1}\\
\textcolor{blue}{\textbf{Revision:} #2}\par\vspace{0.8em}
}
...
\afterpreface                      
  \include{chapters_after_preface/1_introduction}
    ...
    \include{chapters_after_preface/2_Background}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

    \include{chapters_after_preface/3_RelatedWork}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}   

    \include{chapters_after_preface/4_Methodology}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

    \include{chapters_after_preface/5_Implementation}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
    

    \include{chapters_after_preface/6_Experiments}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

    \include{chapters_after_preface/7_Conclusion}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
